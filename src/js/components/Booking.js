...
class Booking {
  ...
  initTables(event) {
    ...
    if (clickedElement.classList.contains('table')) {
      ...
      if (clickedElement.classList.contains('booked')) {
        ...
        const selectedTable = thisBooking.dom.tablesWrapper.querySelector('.table.selected');
        if (selectedTable) {
          selectedTable.classList.remove('selected');
        }
  
        thisBooking.selectTable = tableNumber;
  ...
  sendBooking(){
    const thisBooking = this;
    const starters = [];
    const starterCheckboxes = thisBooking.dom.wrapper.querySelectorAll('[name="starter"]');
